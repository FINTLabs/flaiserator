...
class FlaisResourceReconciliationUpdateFilter : OnUpdateFilter<FlaisResource<*>> {
    override fun accept(
        newResource: FlaisResource<*>,
        oldResource: FlaisResource<*>,
    ): Boolean = shouldReconcile(newResource)

    override fun and(onUpdateFilter: OnUpdateFilter<FlaisResource<*>>): OnUpdateFilter<FlaisResource<*>> {
