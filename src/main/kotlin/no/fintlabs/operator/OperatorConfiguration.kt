...
class OperatorConfiguration :
    ...
    OperatorConfigurationOverrider,
    KoinComponent {
    ...
    override fun reconciliationTerminationTimeout(): Duration = reconciliationTerminationTimeout ?: super.reconciliationTerminationTimeout()
