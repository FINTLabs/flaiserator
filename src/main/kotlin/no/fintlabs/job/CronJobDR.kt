...
class CronJobDR :
    CRUDKubernetesDependentResource<CronJob, FlaisJob>(CronJob::class.java), KoinComponent {
                ...
                JobTemplateSpec().apply {
                  ...
                  spec =
                      JobSpec().apply {
                        ...
                        template =
                            podTemplate.apply { spec.restartPolicy = primary.spec.restartPolicy }
                      }
                }
          }
    }
